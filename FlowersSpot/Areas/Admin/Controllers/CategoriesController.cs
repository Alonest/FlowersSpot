...
namespace FlowersSpot.Areas.Admin.Controllers
{
    ...
    public class CategoriesController : Controller
    {
        ...
        public CategoriesController(FlowersSpotContext context)
        {
            this.context = context;
        }


        //Metoda GET admin/Categories/INDEX
        public async Task<IActionResult> Index()
        {
            return View(await context.Categories.OrderBy(x => x.Sorting).ToListAsync());
        }

        //Metoda GET admin/Categories/create
        public IActionResult Create() => View();


        //Metoda POST admin/Categories/create
        [HttpPost]
        ...
        //Metoda GET admin/Categories/EDIT
        ...
        //Metoda POST admin/categories/EDIT/id
        [HttpPost]
        [ValidateAntiForgeryToken]
        ...
        //Metoda GET admin/category/DELETE
        ...
        //Metoda POST admin/categories/ReOrder
        [HttpPost]
